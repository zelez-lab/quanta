...
/// (see `crates/gpu/quanta-ir/src/emit_msl/ops.rs:43` and
/// `crates/gpu/quanta-ir/src/emit_spirv/ops.rs:113`; produced by
/// `crates/gpu/quanta-wasm-lowering/src/lower.rs:427` for scalar
...
/// `crates/gpu/quanta-wasm-lowering/src/lower.rs` BrIf arm).
