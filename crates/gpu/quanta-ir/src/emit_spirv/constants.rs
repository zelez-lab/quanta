...
pub(crate) const OP_U_CONVERT: u16 = 113; // unsigned int width conversion (zero-extend / truncate)
pub(crate) const OP_S_CONVERT: u16 = 114; // signed int width conversion (sign-extend / truncate)
pub(crate) const OP_F_CONVERT: u16 = 115; // float width conversion (f32↔f64, f16↔f32)
