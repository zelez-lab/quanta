...
//!
//! The geometry / pipeline descriptors the drivers speak
//! ([`GeometryDesc`], [`RayTracingPipelineDesc`]) live in
//! `quanta-core`; this module holds the typed wrappers.
//!
...
use quanta_core::{GeometryDesc, RayTracingPipelineDesc};
