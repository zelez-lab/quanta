...
fn shader_type_wgsl(ty: quanta_ir::ShaderType) -> &'static str {
    match ty {
        quanta_ir::ShaderType::F32 => "f32",
        quanta_ir::ShaderType::Vec2 => "vec2<f32>",
        quanta_ir::ShaderType::Vec3 => "vec3<f32>",
        quanta_ir::ShaderType::Vec4 => "vec4<f32>",
        quanta_ir::ShaderType::Mat4 => "mat4x4<f32>",
        quanta_ir::ShaderType::Mat3 => "mat3x3<f32>",
    }
}
