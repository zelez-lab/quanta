...
| Backend | GEMM status |
|---------|-------------|
| Software (CPU) | correct (differential tests; gemv 9/9; mixed bf16/f16/fp8 11/11; quant int8+int4 11/11) |
| Metal (M1 Pro) | correct + benched (above); gemv 9/9; mixed bf16/f16/fp8 11/11; quant int8+int4 11/11 |
