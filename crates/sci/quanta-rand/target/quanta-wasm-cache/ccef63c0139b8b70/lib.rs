...
fill_lognormal_f32(out : * mut f32, mu : f32, seed_hi : u32, seed_lo : u32,
sigma : f32)
{
    #[allow(unused_imports)] use crate :: quanta :: intrinsics :: * ; unsafe
    {
        {
            let id = quark_id(); let r0 : u32 =
            philox4x32_10_first_u32_kernel(id, 0u32, 0u32, 0u32, seed_lo,
            seed_hi); let r1 : u32 =
            philox4x32_10_first_u32_kernel(id, 1u32, 0u32, 0u32, seed_lo,
            seed_hi); let bits0 : u32 = r0 >> 8u32; let bits1 : u32 = r1 >>
            8u32; let u1 : f32 = (bits0 as f32) * (1.0f32 / 16_777_216.0f32) +
            (1.0f32 / 33_554_432.0f32); let u2 : f32 = (bits1 as f32) *
            (1.0f32 / 16_777_216.0f32) + (1.0f32 / 33_554_432.0f32); let r :
            f32 = sqrt(- 2.0f32 * ln(u1)); let two_pi : f32 =
            6.2831_8530_7179_586f32; let theta : f32 = two_pi * u2; let n1 :
            f32 = r * cos(theta); let n2 : f32 = r * sin(theta); let v1 : f32
            = exp(mu + sigma * n1); let v2 : f32 = exp(mu + sigma * n2); let
            idx0 : u32 = id.wrapping_mul(2u32); let idx1 : u32 =
