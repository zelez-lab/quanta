...
fill_normal_f32(out : * mut f32, seed_hi : u32, seed_lo : u32)
{
    ...
    {
        {
            ...
            (1.0f32 / 16_777_216.0f32) + (1.0f32 / 33_554_432.0f32); let ln_u1
            : f32 = ln(u1); let r : f32 = sqrt(- 2.0f32 * ln_u1); let two_pi :
            f32 = 6.2831_8530_7179_586f32; let theta : f32 = two_pi * u2; let
            n1 : f32 = r * cos(theta); let n2 : f32 = r * sin(theta); let idx0
            : u32 = id.wrapping_mul(2u32); let idx1 : u32 =
