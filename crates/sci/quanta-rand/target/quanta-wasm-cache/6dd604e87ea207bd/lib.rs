...
fill_exponential_f64(out : * mut f64, lambda : f64, seed_hi : u32, seed_lo :
u32)
{
    #[allow(unused_imports)] use crate :: quanta :: intrinsics :: * ; unsafe
    {
        {
            let id = quark_id(); let ra : u32 =
            philox4x32_10_first_u32_kernel(id, 0u32, 0u32, 0u32, seed_lo,
            seed_hi); let rb : u32 =
            philox4x32_10_first_u32_kernel(id, 1u32, 0u32, 0u32, seed_lo,
            seed_hi); let packed : u64 = ((ra as u64) << 32u32) | (rb as u64);
            let bits : u64 = packed >> 11u32; let u : f64 = (bits as f64) *
            (1.0f64 / 9_007_199_254_740_992.0f64) +
            (1.0f64 / 18_014_398_509_481_984.0f64); let lam : f64 = lambda;
            let v : f64 = - log_f64(u) / lam; *
            (out.add((id as usize) as usize)) = v;
        }
    }
}
