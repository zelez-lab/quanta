...
fill_uniform_f32(out : * mut f32, seed_hi : u32, seed_lo : u32)
{
    ...
    {
        {
            ...
            seed_hi); let bits : u32 = r >> 8u32; let v : f32 = (bits as f32)
            * (1.0f32 / 16_777_216.0f32); * (out.add((id as usize) as usize))
            = v;
        }
    }
}
