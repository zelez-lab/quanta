...
fill_normal_f64(out : * mut f64, seed_hi : u32, seed_lo : u32)
{
    ...
    {
        {
            ...
            (1.0f64 / 18_014_398_509_481_984.0f64); let ln_u1 : f64 =
            log_f64(u1); let r : f64 = sqrt_f64(- 2.0f64 * ln_u1); let two_pi
            : f64 = 6.283_185_307_179_586f64; let theta : f64 = two_pi * u2;
            let n1 : f64 = r * cos_f64(theta); let n2 : f64 = r *
            sin_f64(theta); let idx0 : u32 = id.wrapping_mul(2u32); let idx1 :
            u32 = id.wrapping_mul(2u32).wrapping_add(1u32); *
            (out.add((idx0 as usize) as usize)) = n1; *
            (out.add((idx1 as usize) as usize)) = n2;
        }
    }
}
