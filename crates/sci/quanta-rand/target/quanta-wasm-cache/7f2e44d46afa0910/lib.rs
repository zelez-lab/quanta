...
fill_uniform_f64(out : * mut f64, seed_hi : u32, seed_lo : u32)
{
    #[allow(unused_imports)] use crate :: quanta :: intrinsics :: * ; unsafe
    {
        {
            let id = quark_id(); let hi : u32 =
            philox4x32_10_first_u32_kernel(id, 0u32, 0u32, 0u32, seed_lo,
            seed_hi); let lo : u32 =
            philox4x32_10_first_u32_kernel(id, 1u32, 0u32, 0u32, seed_lo,
            seed_hi); let packed : u64 = ((hi as u64) << 32u32) | (lo as u64);
            let bits : u64 = packed >> 11u32; let v : f64 = (bits as f64) *
