...
fill_lognormal_f64(out : * mut f64, mu : f64, seed_hi : u32, seed_lo : u32,
sigma : f64)
{
    #[allow(unused_imports)] use crate :: quanta :: intrinsics :: * ; unsafe
    {
        {
            let id = quark_id(); let r0a : u32 =
            philox4x32_10_first_u32_kernel(id, 0u32, 0u32, 0u32, seed_lo,
            seed_hi); let r0b : u32 =
            philox4x32_10_first_u32_kernel(id, 1u32, 0u32, 0u32, seed_lo,
            seed_hi); let r1a : u32 =
            philox4x32_10_first_u32_kernel(id, 2u32, 0u32, 0u32, seed_lo,
            seed_hi); let r1b : u32 =
            philox4x32_10_first_u32_kernel(id, 3u32, 0u32, 0u32, seed_lo,
            seed_hi); let packed0 : u64 = ((r0a as u64) << 32u32) |
            (r0b as u64); let packed1 : u64 = ((r1a as u64) << 32u32) |
            (r1b as u64); let bits0 : u64 = packed0 >> 11u32; let bits1 : u64
            = packed1 >> 11u32; let u1 : f64 = (bits0 as f64) *
            (1.0f64 / 9_007_199_254_740_992.0f64) +
            (1.0f64 / 18_014_398_509_481_984.0f64); let u2 : f64 =
            (bits1 as f64) * (1.0f64 / 9_007_199_254_740_992.0f64) +
            (1.0f64 / 18_014_398_509_481_984.0f64); let r : f64 =
            sqrt_f64(- 2.0f64 * log_f64(u1)); let two_pi : f64 =
            6.283_185_307_179_586f64; let theta : f64 = two_pi * u2; let n1 :
            f64 = r * cos_f64(theta); let n2 : f64 = r * sin_f64(theta); let
            mu : f64 = mu; let sigma : f64 = sigma; let v1 : f64 =
            exp_f64(mu + sigma * n1); let v2 : f64 = exp_f64(mu + sigma * n2);
            let idx0 : u32 = id.wrapping_mul(2u32); let idx1 : u32 =
            id.wrapping_mul(2u32).wrapping_add(1u32); *
            (out.add((idx0 as usize) as usize)) = v1; *
            (out.add((idx1 as usize) as usize)) = v2;
        }
    }
}
