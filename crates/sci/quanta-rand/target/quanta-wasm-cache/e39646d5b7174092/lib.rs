...
fill_exponential_f32(out : * mut f32, lambda : f32, seed_hi : u32, seed_lo :
u32)
{
    #[allow(unused_imports)] use crate :: quanta :: intrinsics :: * ; unsafe
    {
        {
            let id = quark_id(); let r : u32 =
            philox4x32_10_first_u32_kernel(id, 0u32, 0u32, 0u32, seed_lo,
            seed_hi); let bits : u32 = r >> 8u32; let u : f32 = (bits as f32)
            * (1.0f32 / 16_777_216.0f32) + (1.0f32 / 33_554_432.0f32); let v :
            f32 = - ln(u) / lambda; * (out.add((id as usize) as usize)) = v;
        }
    }
}
