...
trmm_upper_f32(a : * const f32, b : * mut f32, nt : u32, nlanes : u32, lb :
    ...
    {
        {
            ...
            nlanes { nt } else { 0u32 }; let mut i : u32 = 0u32; while i <
            rows
            {
                let mut acc : f32 = 0.0f32; let mut p : u32 = i; while p < nt
                {
                    let mip = *
