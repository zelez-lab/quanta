...
#[doc = " Block-wide u32 min reduction. Result in lane 0 of the"]
#[doc = " workgroup. Identity element: u32::MAX. See module-level docs"]
#[doc = " for caller contract."] #[allow(dead_code, unused_unsafe)] pub fn
block_reduce_min_u32_kernel(value : u32) -> u32
{
    let warp_min = unsafe { reduce_min_u32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_u32(0, warp_id, warp_min) }; } unsafe
    { barrier() }; let partial = unsafe { shared_load_u32(0, lane_in_warp) };
    unsafe { reduce_min_u32(partial) }
}

#[unsafe (no_mangle)] pub unsafe extern "C" fn
block_reduce_min_u32_buffer(data : * const u32, out : * mut u32)
{
    ...
    {
        {
            ...
            { shared_store_u32(0u32, (lane) as u32, 4294967295u32); }
            barrier(); let value = * (data.add((i as usize) as usize)); let
            block_min = block_reduce_min_u32_kernel(value); if lane == 0u32
