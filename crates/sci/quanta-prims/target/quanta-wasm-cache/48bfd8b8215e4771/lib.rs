...
#[doc = " Block-wide u32 max reduction. Result in lane 0 of the"]
#[doc = " workgroup. Identity element: 0. See module-level docs for"]
#[doc = " caller contract."] #[allow(dead_code, unused_unsafe)] pub fn
block_reduce_max_u32_kernel(value : u32) -> u32
{
    let warp_max = unsafe { reduce_max_u32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_u32(0, warp_id, warp_max) }; } unsafe
...
block_reduce_max_u32_buffer(data : * const u32, out : * mut u32)
{
    ...
    {
        {
            ...
            value = * (data.add((i as usize) as usize)); let block_max =
            block_reduce_max_u32_kernel(value); if lane == 0u32
