...
#[doc = " Block-wide f32 min reduction. Result in lane 0 of the"]
#[doc = " workgroup. Identity element: f32::INFINITY. See module-level"]
#[doc = " docs for caller contract."] #[allow(dead_code, unused_unsafe)] pub
fn block_reduce_min_f32_kernel(value : f32) -> f32
{
    let warp_min = unsafe { reduce_min_f32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_f32(0, warp_id, warp_min) }; } unsafe
...
block_reduce_min_f32_buffer(data : * const f32, out : * mut f32)
{
    ...
    {
        {
            ...
            let value = * (data.add((i as usize) as usize)); let block_min =
            block_reduce_min_f32_kernel(value); if lane == 0u32
