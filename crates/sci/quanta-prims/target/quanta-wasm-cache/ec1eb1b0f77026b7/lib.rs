...
block_radix_sort_u32_buffer(data : * const u32, out : * mut u32)
{
    ...
    {
        {
            ...
            (data.add((i as usize) as usize))); barrier(); let mut shift : u32
            = 0u32; while shift < 32u32
            {
                let my_key = shared_load_u32(0u32, (lane) as u32); let digit =
                ...
                shared_store_u32(1u32, (lane) as u32, s_0 + s_1 * 65536u32);
                shared_store_u32(2u32, (lane) as u32, s_2 + s_3 * 65536u32);
                barrier(); let mut d : u32 = 1u32; while d < 256u32
                {
                    let mut v01 : u32 = shared_load_u32(1u32, (lane) as u32);
                    let mut v23 : u32 = shared_load_u32(2u32, (lane) as u32); if
                    lane >= d
                    {
                        v01 = v01 + shared_load_u32(1u32, (lane - d) as u32); v23 =
                        v23 + shared_load_u32(2u32, (lane - d) as u32);
                    } barrier(); shared_store_u32(1u32, (lane) as u32, v01);
                    shared_store_u32(2u32, (lane) as u32, v23); barrier(); d = d
                    * 2u32;
                } let t01 = shared_load_u32(1u32, (255u32) as u32); let t23 =
                shared_load_u32(2u32, (255u32) as u32); let total0 = t01 &
                ...
                shared_load_u32(1u32, (lane) as u32); let inc23 =
                shared_load_u32(2u32, (lane) as u32); let rank0 =
                ...
                shared_store_u32(0u32, (my_pos) as u32, my_key); barrier();
                shift = shift + 2u32;
