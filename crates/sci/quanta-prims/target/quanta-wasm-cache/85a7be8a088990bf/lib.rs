...
#[doc = " Block-wide u32 sum reduction. Result in lane 0 of the"]
#[doc = " workgroup. See module-level docs for caller contract."]
#[allow(dead_code, unused_unsafe)] pub fn
block_reduce_add_u32_kernel(value : u32) -> u32
{
    let warp_sum = unsafe { reduce_add_u32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_u32(0, warp_id, warp_sum) }; } unsafe
...
block_reduce_add_u32_buffer(data : * const u32, out : * mut u32)
{
    ...
    {
        {
            ...
            block_reduce_add_u32_kernel(value); if lane == 0u32
