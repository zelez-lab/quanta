...
#[doc = " Block-wide i32 min reduction. Result in lane 0 of the"]
#[doc = " workgroup. Identity element: i32::MAX. See module-level docs"]
#[doc = " for caller contract."] #[allow(dead_code, unused_unsafe)] pub fn
block_reduce_min_i32_kernel(value : i32) -> i32
{
    let warp_min = unsafe { reduce_min_i32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_i32(0, warp_id, warp_min) }; } unsafe
    { barrier() }; let partial = unsafe { shared_load_i32(0, lane_in_warp) };
    unsafe { reduce_min_i32(partial) }
}

#[unsafe (no_mangle)] pub unsafe extern "C" fn
block_reduce_min_i32_buffer(data : * const i32, out : * mut i32)
{
    ...
    {
        {
            ...
            { shared_store_i32(0u32, (lane) as u32, 2147483647i32); }
            barrier(); let value = * (data.add((i as usize) as usize)); let
            block_min = block_reduce_min_i32_kernel(value); if lane == 0u32
            { * (out.add((block as usize) as usize)) = block_min; }
        }
    }
}
