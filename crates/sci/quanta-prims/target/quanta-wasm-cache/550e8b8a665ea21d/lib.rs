...
#[doc = " Block-wide f32 sum reduction. Result in lane 0 of the"]
#[doc = " workgroup. See module-level docs for caller contract."]
#[allow(dead_code, unused_unsafe)] pub fn
block_reduce_add_f32_kernel(value : f32) -> f32
{
    let warp_sum = unsafe { reduce_add_f32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_f32(0, warp_id, warp_sum) }; } unsafe
...
block_reduce_add_f32_buffer(data : * const f32, out : * mut f32)
{
    ...
    {
        {
            ...
            value = * (data.add((i as usize) as usize)); let block_sum =
            block_reduce_add_f32_kernel(value); if lane == 0u32
            { * (out.add((block as usize) as usize)) = block_sum; }
        }
    }
}
