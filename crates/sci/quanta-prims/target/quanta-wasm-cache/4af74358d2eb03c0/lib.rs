...
block_segmented_scan_add_u32_buffer(data : * const u32, flags : * const u32,
out : * mut u32)
{
    ...
    {
        {
            ...
            (flags.add((i as usize) as usize))); barrier(); let mut d : u32 =
            1u32; while d < 256u32
            {
                let mut v_new : u32 = shared_load_u32(0u32, (lane) as u32);
                let mut f_new : u32 = shared_load_u32(1u32, (lane) as u32); if
                lane >= d
                {
                ...
                shared_store_u32(1u32, (lane) as u32, f_new); barrier(); d = d
                * 2u32;
