...
#[doc = " Block-wide i32 max reduction. Result in lane 0 of the"]
#[doc = " workgroup. Identity element: i32::MIN. See module-level docs"]
#[doc = " for caller contract."] #[allow(dead_code, unused_unsafe)] pub fn
block_reduce_max_i32_kernel(value : i32) -> i32
{
    let warp_max = unsafe { reduce_max_i32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_i32(0, warp_id, warp_max) }; } unsafe
...
block_reduce_max_i32_buffer(data : * const i32, out : * mut i32)
{
    ...
    {
        {
            ...
            { shared_store_i32(0u32, (lane) as u32, - 2147483648i32); }
            barrier(); let value = * (data.add((i as usize) as usize)); let
            block_max = block_reduce_max_i32_kernel(value); if lane == 0u32
