...
#[doc = " Block-wide i32 sum reduction. Result in lane 0 of the"]
#[doc = " workgroup. See module-level docs for caller contract."]
#[allow(dead_code, unused_unsafe)] pub fn
block_reduce_add_i32_kernel(value : i32) -> i32
{
    let warp_sum = unsafe { reduce_add_i32(value) }; let sub_size = unsafe
    ...
    { unsafe { shared_store_i32(0, warp_id, warp_sum) }; } unsafe
...
block_reduce_add_i32_buffer(data : * const i32, out : * mut i32)
{
    ...
    {
        {
            ...
            block_reduce_add_i32_kernel(value); if lane == 0u32
