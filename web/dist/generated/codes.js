...
export const SPEC_GPUTextureFormat = [
    "r8unorm",
    "r8snorm",
    "r8uint",
    "r8sint",
...
export const SPEC_GPUPrimitiveTopology = [
    "point-list",
    "line-list",
    "line-strip",
    "triangle-list",
...
export const SPEC_GPUFrontFace = [
    "ccw",
    "cw",
];
/** W3C `webgpu.idl` enum `GPUCullMode` — 3 values. */
export const SPEC_GPUCullMode = [
    "none",
    "front",
    "back",
];
/** W3C `webgpu.idl` enum `GPUBlendFactor` — 17 values. */
export const SPEC_GPUBlendFactor = [
    "zero",
    "one",
    "src",
    "one-minus-src",
...
export const SPEC_GPUBlendOperation = [
    "add",
    "subtract",
    "reverse-subtract",
    "min",
...
export const SPEC_GPUIndexFormat = [
    "uint16",
    "uint32",
];
/** W3C `webgpu.idl` enum `GPUVertexFormat` — 41 values. */
export const SPEC_GPUVertexFormat = [
    "uint8",
    "uint8x2",
    "uint8x4",
    "sint8",
...
export const SPEC_GPUVertexStepMode = [
    "vertex",
    "instance",
];
/** W3C `webgpu.idl` enum `GPULoadOp` — 2 values. */
export const SPEC_GPULoadOp = [
    "load",
    "clear",
];
/** W3C `webgpu.idl` enum `GPUStoreOp` — 2 values. */
export const SPEC_GPUStoreOp = [
    "store",
    "discard",
];
/**
 ...
 */
export function assertSpecSubset(enumName, specTable, quantaStrings) {
    for (const s of quantaStrings) {
        if (!specTable.includes(s)) {
            throw new Error(`quanta-codegen: ${enumName} value ${JSON.stringify(s)} is not in the spec ` +
