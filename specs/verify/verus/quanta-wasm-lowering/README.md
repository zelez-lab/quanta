...
snapshot in the Lean `Translate.lean` `wloop` arm — and proving its *semantic*
preservation — therefore requires first lifting `ScaledIdx` into the Lean slice
