...
import Quanta.Wasm.PreservationIfBody
...
-- SVD (one-sided Jacobi): right-rotation orthogonality + Frobenius-norm preservation + column-pair orthogonalisation
import Quanta.Blas.Svd
