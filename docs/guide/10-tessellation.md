...
[Vertex and fragment shaders: Other stages](08-vertex-fragment.md#other-shader-stages).
...
- [Mesh shaders](11-mesh-shaders.md) -- the modern alternative
- [Rendering](07-rendering.md) -- the surrounding pipeline
