...
- [Shared Memory](03-shared-memory.md) — the `#[quanta::shared]` scratch the primitives rely on
- [Device Functions](09-device-functions.md) — how `#[quanta::device]` calls are inlined
