...
- [Vector Add](cookbook/vector-add.md)
- [Matrix Multiply](cookbook/matrix-multiply.md)
- [Parallel Reduce](cookbook/parallel-reduce.md)
- [Histogram](cookbook/histogram.md)
- [Image Blur](cookbook/image-blur.md)
- [N-Body Simulation](cookbook/nbody-simulation.md)
- [Particle System](cookbook/particle-system.md)
