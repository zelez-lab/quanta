...
fn try_gpu() -> Option<quanta::Gpu> {
    quanta::init()
        ...
        // Paravirtual device" that SIGABRTs in the compute-ICB path
        // (same class as gpu_advanced / icb_render_metal — see their
        // probes). Real Apple hardware runs everything.
        .filter(|g| {
